...
public class Task_0018_MaximumPathSumI {

	public static void main(String[] args) {

		int[][] pyramid = new int[][] { { 75 }, { 95, 64 }, { 17, 47, 82 }, { 18, 35, 87, 10 }, { 20, 04, 82, 47, 65 },
		...
		for (int i = pyramid.length - 2; i >= 0; i--) { // zacinam na predposlednim radku
		...
		System.out.println("Maximalni cesta :" + pyramid[0][0]);
	}
